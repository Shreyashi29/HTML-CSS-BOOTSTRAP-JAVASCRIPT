...
function setUpCard(book) {
    if (colCounter == 0) {
        ...
        rowx.setAttribute('id', rowid) 
        rowx.classList.add('card-deck') 
        rowx.classList.add('p-3') 
        rowx.classList.add('pb-1') 
